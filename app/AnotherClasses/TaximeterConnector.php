...
class TaximeterConnector
{
    ...
    public static function createDriver(DriverBuilder $driverInfo)
    {
        TaximeterConnector::$user_cookie_file = base_path('resources/cookies.txt');
        $yandexDataForAuth = TaximeterConnector::auth();
...
//    public static function changeDriverPhone($old, $new) {
//        $driverProfile = TaximeterConnector::getDriverProfile($old);
//        $diverAccId = $driverProfile["accounts"][0]["id"];
//
//        TaximeterConnector::$user_cookie_file = base_path('resources/cookies.txt');
//        $yandexDataForAuth = TaximeterConnector::auth();
//
//        $driverEditToken = TaximeterConnector::getEditDriverToken($diverAccId);
//
//        $url = 'https://lk.taximeter.yandex.ru/driver/' . $diverAccId;
//
//        $ch = curl_init($url);
//
//        curl_setopt($ch, CURLOPT_POST, 1); //Будем отправлять POST запрос
...
/*    public static function getEditDriverToken($accountId) {
        TaximeterConnector::$user_cookie_file = base_path('resources/cookies.txt');

        $yandexDataForAuth = TaximeterConnector::auth();

        $url = 'https://lk.taximeter.yandex.ru/driver/' . $accountId . '/edit';
